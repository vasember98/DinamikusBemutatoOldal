<script lang="ts">
  ...
  // Host wrapper for geometry calculations
  ...
  // Keep the ordered child ids in sync with the graph
  ...
  // Collect DOM refs for each child using an action
  ...
  // Hover + insertion computations for vertical layout
...
<!-- Host wrapper: we bind here to get an HTMLElement (not a component instance) -->
